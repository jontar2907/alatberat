...
<body>
    <h2>Pengajuan Sewa Anda Disetujui</h2>
    <p>Detail alat: <strong>{{ $rentalRequest->heavyEquipment->name ?? '-' }}</strong></p>
    ...
    <p>Silakan lanjutkan ke proses pembayaran dengan mengklik link berikut:</p>
